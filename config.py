...
# σ הוא סטיית תקן של הרעש בתחזית. נשתמש בערך הגבוה יותר מבין:
#   (א) הפיזור בין חמשת המודלים (חוסר הסכמה = אי-ודאות)
#   (ב) MIN_SIGMA — רצפה שמייצגת אי-ודאות שיורית גם כשהמודלים מסכימים
#       (רעש דגימה, מיקרו-אקלים, דיוק מדידה).
# ירדנו מ-0.7 ל-0.5 כי 0.7 ניפח הסתברויות ב-buckets רחוקים מהממוצע
# ויצר איתותי קנייה שגויים על אירועים לא-סבירים.
MIN_SIGMA = 0.5
